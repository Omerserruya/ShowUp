    ...
    plans_data = [
        {
            ...
            "is_active": True,
            "campaigns": [
                {"enabled": True, "label": "תזכורת שבוע לפני", "offset_days": 7, "time": "12:00"},
                {"enabled": True, "label": "תזכורת יום לפני", "offset_days": 1, "time": "18:00"},
            ],
        ...
        },
        {
            ...
            "is_active": True,
            "campaigns": [
                {"enabled": True, "label": "Save the date", "offset_days": 30, "time": "10:00"},
                {"enabled": True, "label": "תזכורת שבוע לפני", "offset_days": 7, "time": "12:00"},
                {"enabled": True, "label": "תזכורת יום לפני", "offset_days": 1, "time": "18:00"},
                {"enabled": False, "label": "תודה אחרי האירוע", "offset_days": -1, "time": "11:00"},
            ],
            "created_at": datetime.utcnow(),
            "updated_at": datetime.utcnow(),
        },
        {
            ...
            "campaigns": [
                ...
                {"enabled": True, "label": "תזכורת שבוע לפני", "offset_days": 7, "time": "12:00"},
                {"enabled": True, "label": "תזכורת יום לפני", "offset_days": 1, "time": "18:00"},
                {"enabled": True, "label": "תודה אחרי האירוע", "offset_days": -1, "time": "11:00"},
            ],
            "created_at": datetime.utcnow(),
            "updated_at": datetime.utcnow(),
        },
