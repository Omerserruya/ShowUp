...
class BaseState:
    ...
    async def process_incoming(self, session: AsyncSession, message: Dict[str, Any], conversation: Any) -> None:
        ...
        logger.info(
            ...
            extra={
                "guest_id": str(guest_id_value) if guest_id_value else None,
                "guest_phone": guest_phone_value,
        ...
        try:
            ...
            if guest_id_value:
                ...
                if result.rowcount > 0:
                    ...
                    logger.info(f"Successfully updated last_response by guest_id {guest_id_value}, rows updated: {result.rowcount}")
                    return
            ...
            if result.rowcount > 0:
                ...
                check_result = await session.execute(
                    text("""
                        SELECT id, phone, event_id::text as event_id_str 
                        FROM guests 
